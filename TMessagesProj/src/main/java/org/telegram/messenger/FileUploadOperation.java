...
//                }
                ...
                if (AccountInstance.getInstance(currentAccount).getUserConfig().isPremium() && org.telegram.messenger.MessagesController.getGlobalMainSettings().getBoolean("localPremium", false) && totalFileSize > FileLoader.DEFAULT_MAX_FILE_SIZE) {
